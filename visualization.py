...
class AudioVisualizer:
    ...
    def generate_channel_activity_plot(self, user_windows, agent_windows, duration, filename=""):
        """
        ...
        for start, end in user_windows:
            ax.add_patch(plt.Rectangle((start, 0.9), end - start, 0.2, 
                                      color='blue', alpha=0.7))
        
        # Plot agent activity (top row)
        for start, end in agent_windows:
            ax.add_patch(plt.Rectangle((start, 1.9), end - start, 0.2, 
    ...
    def generate_latency_histogram(self, latencies):
        ...
        if not latencies:
            ...
            ax.axvline(avg_latency, color='red', linestyle='dashed', linewidth=2,
