...
def print_metrics_summary(metrics):
    ...
    print(f"P10/P50/P90 Latency: {latency['p10_latency']:.2f}/{latency['p50_latency']:.2f}/{latency['p90_latency']:.2f} ms")
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description='Audio Analysis for Customer Service Evaluation')
    parser.add_argument('--input-dir', default='stereo_test_calls', 
                        help='Directory containing input audio files')
    parser.add_argument('--output-dir', default='sampled_test_calls', 
